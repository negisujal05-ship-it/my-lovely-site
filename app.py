...
# --- PURE PYTHON STRING VARIABLES FOR VISUAL STYLING ---
CSS_BASE_STYLE = """
<style>
.stApp {
...
# HTML Layout elements stored as clean Python Strings to avoid escape sequence issues
CARD_V1_START = '<div style="background: rgba(5, 3, 12, 0.95); padding: 35px; border-radius: 25px; border: 2px solid #ffffff; box-shadow: 0px 0px 35px rgba(255, 255, 255, 0.3); text-align: center; position: relative; z-index: 2; margin-bottom: 30px;">'
CARD_V1_END = '</div>'

VIKAR_TEMPLATE_START = '<div style="background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.2); padding: 20px; border-radius: 15px; margin-bottom: 20px; text-align: left; box-shadow: 0 4px 15px rgba(0,0,0,0.5);">'
VIKAR_TEMPLATE_END = '</div>'

# Injecting Global Base CSS Design
...
# --- PAGE 2 ---
    ...
    str.markdown(CARD_V1_END, unsafe_allow_html=True)
