...
# Custom CSS - Deep Black Galaxy Background, Glowing Moon, Fixed White Stars & Falling Hearts/Rain
str.markdown("""
    <style>
...
if click_me:
    with str.spinner("Aapke liye baarish ki boondein aur dil saja raha hoon... 🌌"):
        time.sleep(1.8)
    
    # Ab falling pool mein sirf Raindrops (Baarish) aur Red Hearts girenge (Stars background mein ruke rahenge)
    falling_html = ""
    rain_items = ["💧", "❄️"]
    red_hearts = ["❤️", "💖", "💘"]
    
    # Generating 45 elements (Only Rain & Hearts falling)
    for i in range(45):
